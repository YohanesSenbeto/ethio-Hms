                ...
                <div className="row">
                    <div className="col-md-3 ml-5 mr-5 mb-1">
                        ...
                        >
                            ...
                            <Card.Body>
                                <Card.Title>
                                    Inaugeration of New Section
                                </Card.Title>
                                <Card.Text className="text-white">
                                    A Section containing facilities such as a
                                    new Research and Developement Cell,
                    ...
                    <div className="col-md-3 ml-3 mr-3">
                        <Card
                            ...
                            style={{ width: "18rem" }}
                        >
                            <Card.Header>Best Hospital System</Card.Header>
                            <Card.Body>
                                <Card.Title>
                                    Best Hospital system in Ethiopia
                                </Card.Title>
                                <Card.Text>
                                    We are overwhelmed by the support our
                                    patients provide us and you made us the best
                                    in Ethiopia!
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    ...
                    <div className="col-md-3 ml-3 mr-2">
                        ...
                        >
                            ...
                            <Card.Body>
                                ...
                                <Card.Text>
                                    Researcher Dr. Nafyad found a new cure for
